...
public:
	...
	virtual CRGB Pixel(int16_t x, int16_t y) = 0;
};

class cLEDMatrixBase : public iDrawable
{
  protected:
  ...
  public:
    ...
    int16_t Size()  { return(m_Width * m_Height); }
    ...
    void DrawPattern(iDrawable *d, int16_t x, int16_t y);
    void DrawPattern(iDrawable *d, int16_t x, int16_t y, CRGB ColTransparent);
    void DrawPattern(iDrawable *d, int16_t x, int16_t y, bool transparency, CRGB ColTransparent);
    void DrawPattern(iDrawable *d, int16_t x, int16_t y, bool transparency, CRGB ColTransparent, bool flipHoriz, bool flipVert);
    void DrawPattern(iDrawable *d, int16_t x, int16_t y, bool transparency, CRGB ColTransparent, RotationType_t rotate);
    void DrawPattern(iDrawable *d, int16_t x, int16_t y, bool transparency, CRGB ColTransparent, RotationType_t rotate, bool flipHoriz, bool flipVert);
    virtual CRGB Pixel(int16_t x, int16_t y) {return m_LED[mXY(x, y)];}
};
